package com.qsl.springboot.bigfile.client;

import com.qsl.springboot.bigfile.core.FilePartition;
import com.qsl.springboot.bigfile.core.FilePartitionUtil;
import com.qsl.springboot.bigfile.core.ParseWorker;
...
public class MainControl {
    ...
    public static void main(String[] args) throws IOException {
        // 大文件路径
        String filePath = "D:" + File.separator + "bigfile1GB.txt";
        ...
        //对文件进行切分
        List<FilePartition> partition1 = FilePartitionUtil.partition1(startPosition, splitCount, totalSize, randomAccessFile);
        ...
        CyclicBarrier barrier = new CyclicBarrier(partition1.size(), () -> {
