...
public class JedisTest {
    ...
    public static void main(String[] args) {
        Jedis jedis = new Jedis(RedisConstant.REDIS_HOST);
        ...
        long dianzanCounter = Long.parseLong(jedis.get("article:1:dianzan"));
        System.out.println("博客的点赞次数为：" + dianzanCounter);

        jedis.decr("article:1:dianzan");
        dianzanCounter = Long.parseLong(jedis.get("article:1:dianzan"));
